...
public class Part14_GoogleApp extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_part14__google_app);
        ...
        browserBtn=findViewById(R.id.btn_web);
        ...
        reqWidth=getResources().getDimensionPixelSize(R.dimen.request_imnage_width);
        reqHeight=getResources().getDimensionPixelSize(R.dimen.request_imnage_height);
        ...
        if(v==contactsBtn){
            ...
            if(ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                ...
                try{
                    ...
                    Log.d("TAAK","파일주소: "+filePath);
                    Uri phoneURI=FileProvider.getUriForFile(Part14_GoogleApp.this, BuildConfig.APPLICATION_ID+
                            ".provider", filePath);
                    Intent intent=new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
            ...
            ==PackageManager.PERMISSION_GRANTED){
                Intent intent=new Intent(Intent.ACTION_CALL, Uri.parse("tel:010-3538-9742"));
                startActivity(intent);
            }else{
            ...
            Uri photoURL=FileProvider.getUriForFile(Part14_GoogleApp.this,BuildConfig.APPLICATION_ID+".provider",filePath);
