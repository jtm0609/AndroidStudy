package com.jtmcompany.android_study_test.Part22;
...
public class Part22_FusedLocationAPI extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_part22__fused_location_api);
    ...
    private void setLocationInfo(Location location){
        ...
        if(location != null){
            ...
            onOffView.setImageDrawable(ResourcesCompat.getDrawable(getResources(), R.drawable.error, null));
    ...
    public void onConnected(@Nullable Bundle bundle) {
        if(ContextCompat.checkSelfPermission(this,Manifest.permission.ACCESS_FINE_LOCATION)==PackageManager.PERMISSION_GRANTED){
            providerApi.getLastLocation().addOnSuccessListener(this,
    ...
    public void onConnectionSuspended(int i) {
        Toast.makeText(this, "onConnectionSuspend", Toast.LENGTH_SHORT).show();
    }
